...
class ProfileMeResponse with ClusterItem {
  ...
  ProfileMeResponse copyWith({
    ...
    String? payPeriod,
      ...
      ProfileMeResponse(
        ...
        userSpecializations: userSpecializations ?? this.userSpecializations,
        ratingStatistic: ratingStatistic ?? this.ratingStatistic,
        locationCode: locationCode ?? this.locationCode,
        locationPlaceName: locationPlaceName ?? this.locationPlaceName,
        costPerHour: costPerHour ?? this.costPerHour,
        workplace: workplace ?? this.workplace,
        priority: priority ?? this.priority,
        questsStatistic: questsStatistic ?? this.questsStatistic,
        walletAddress: walletAddress ?? this.walletAddress,
        workerOrEmployerProfileVisibilitySetting:
            workerOrEmployerProfileVisibilitySetting ?? this.workerOrEmployerProfileVisibilitySetting,
        isTotpActive: isTotpActive ?? this.isTotpActive,
        neverEditedProfileFlag: neverEditedProfileFlag ?? this.neverEditedProfileFlag,
  ...
  ProfileMeResponse.clone(ProfileMeResponse object)
      : this(
          ...
          costPerHour: object.costPerHour,
  ...
  factory ProfileMeResponse.fromJson(Map<String, dynamic> json) {
    return ProfileMeResponse(
      ...
      ratingStatistic: json["ratingStatistic"] == null ? null : RatingStatistic.fromJson(json["ratingStatistic"]),
      ...
      workerOrEmployerProfileVisibilitySetting: json[
                  json["role"] == "employer" ? 'employerProfileVisibilitySetting' : 'workerProfileVisibilitySetting'] ==
              null
          ? null
...
class Phone {
  ...
  factory Phone.fromPhoneNumber(PhoneNumber phone) {
    return Phone(
      phone: phone.phoneNumber ?? '',
      fullPhone: phone.phoneNumber ?? '',
      codeRegion: phone.isoCode ?? '',
    );
  }
