...
import '../ui/pages/main_page/wallet_page/deposit_page/store/deposit_store.dart'
    as _i13;
import '../ui/pages/main_page/wallet_page/store/wallet_store.dart' as _i24;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.factory<_i14.EmployerStore>(
        () => _i14.EmployerStore(get<_i9.ApiProvider>()));
    gh.factory<_i15.FilterQuestsStore>(
        () => _i15.FilterQuestsStore(get<_i9.ApiProvider>()));
    gh.factory<_i16.QuestMapStore>(
        () => _i16.QuestMapStore(get<_i9.ApiProvider>()));
    gh.factory<_i17.RaiseViewStore>(
        () => _i17.RaiseViewStore(get<_i9.ApiProvider>()));
    gh.factory<_i18.RestorePasswordStore>(
        () => _i18.RestorePasswordStore(get<_i9.ApiProvider>()));
    gh.factory<_i19.SMSVerificationStore>(
        () => _i19.SMSVerificationStore(get<_i9.ApiProvider>()));
    gh.factory<_i20.SettingsPageStore>(
        () => _i20.SettingsPageStore(get<_i9.ApiProvider>()));
    gh.factory<_i21.SignInStore>(
        () => _i21.SignInStore(get<_i9.ApiProvider>()));
    gh.factory<_i22.SignUpStore>(
        () => _i22.SignUpStore(get<_i9.ApiProvider>()));
    gh.factory<_i23.TwoFAStore>(() => _i23.TwoFAStore(get<_i9.ApiProvider>()));
    gh.factory<_i24.WalletStore>(
        () => _i24.WalletStore(get<_i9.ApiProvider>()));
    ...
    gh.singleton<_i29.Web3>(_i29.Web3());
    ...
    gh.singleton<_i30.MyQuestStore>(_i30.MyQuestStore(get<_i9.ApiProvider>()));
    gh.singleton<_i31.PinCodeStore>(_i31.PinCodeStore(get<_i9.ApiProvider>()));
    gh.singleton<_i32.PortfolioStore>(
        _i32.PortfolioStore(get<_i9.ApiProvider>()));
    gh.singleton<_i33.ProfileMeStore>(
        _i33.ProfileMeStore(get<_i9.ApiProvider>()));
    gh.singleton<_i34.QuestsStore>(_i34.QuestsStore(get<_i9.ApiProvider>()));
    gh.singleton<_i35.UserProfileStore>(
        _i35.UserProfileStore(get<_i9.ApiProvider>()));
    return this;
  }
}
