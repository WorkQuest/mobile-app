...
import '../ui/pages/main_page/create_quest_page/store/create_quest_store.dart'
    as _i7;
import '../ui/pages/main_page/my_quests_page/store/my_quests_store.dart' as _i9;
...
import '../ui/pages/singleton_stores/profile_me_store.dart' as _i10;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.factory<_i9.MyQuestStore>(
        () => _i9.MyQuestStore(get<_i8.ApiProvider>()));
    gh.factory<_i10.ProfileMeStore>(
        () => _i10.ProfileMeStore(get<_i8.ApiProvider>()));
