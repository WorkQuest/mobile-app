...
import '../ui/pages/pin_code_page/store/pin_code_store.dart' as _i15;
import '../ui/pages/profile_me_store/profile_me_store.dart' as _i16;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.factory<_i10.QuestMapStore>(
        () => _i10.QuestMapStore(get<_i8.ApiProvider>()));
    ...
    gh.singleton<_i15.PinCodeStore>(_i15.PinCodeStore(get<_i8.ApiProvider>()));
    gh.singleton<_i16.ProfileMeStore>(
        _i16.ProfileMeStore(get<_i8.ApiProvider>()));
    return this;
  }
}
