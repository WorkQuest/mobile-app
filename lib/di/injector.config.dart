...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.factory<_i15.SettingsPageStore>(
        () => _i15.SettingsPageStore(get<_i8.ApiProvider>()));
    gh.factory<_i16.SignInStore>(
        () => _i16.SignInStore(get<_i8.ApiProvider>()));
    gh.factory<_i17.SignUpStore>(
        () => _i17.SignUpStore(get<_i8.ApiProvider>()));
    gh.factory<_i18.WalletStore>(
        () => _i18.WalletStore(get<_i8.ApiProvider>()));
    gh.factory<_i19.WithdrawPageStore>(
        () => _i19.WithdrawPageStore(get<_i8.ApiProvider>()));
    gh.singleton<_i8.ApiProvider>(_i8.ApiProvider(get<_i3.IHttpClient>()));
    gh.singleton<_i20.PinCodeStore>(_i20.PinCodeStore(get<_i8.ApiProvider>()));
    gh.singleton<_i21.ProfileMeStore>(
        _i21.ProfileMeStore(get<_i8.ApiProvider>()));
    return this;
  }
}
