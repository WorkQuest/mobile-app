...
import '../ui/pages/restore_password_page/store.dart' as _i16;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.factory<_i13.FilterQuestsStore>(
        () => _i13.FilterQuestsStore(get<_i8.ApiProvider>()));
    ...
    gh.factory<_i16.RestorePasswordStore>(
        () => _i16.RestorePasswordStore(get<_i8.ApiProvider>()));
    ...
    gh.singleton<_i32.UserProfileStore>(
        _i32.UserProfileStore(get<_i8.ApiProvider>()));
    return this;
  }
}
