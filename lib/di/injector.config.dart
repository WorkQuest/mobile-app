...
import '../ui/pages/main_page/settings_page/pages/SMS_verification_page/store/sms_verification_store.dart'
    as _i46;
import '../ui/pages/main_page/settings_page/store/settings_store.dart' as _i29;
...
import '../ui/pages/report_page/store/report_store.dart' as _i27;
import '../ui/pages/restore_password_page/store.dart' as _i28;
import '../ui/pages/sign_in_page/store/sign_in_store.dart' as _i30;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.factory<_i21.NetworkStore>(
        () => _i21.NetworkStore(get<_i8.ApiProvider>()));
    gh.factory<_i22.NotificationStore>(
        () => _i22.NotificationStore(get<_i8.ApiProvider>()));
    gh.factory<_i23.OpenDisputeStore>(
        () => _i23.OpenDisputeStore(get<_i8.ApiProvider>()));
    gh.factory<_i24.ProfileVisibilityStore>(
        () => _i24.ProfileVisibilityStore(get<_i8.ApiProvider>()));
    gh.factory<_i25.QuestDetailsStore>(
        () => _i25.QuestDetailsStore(get<_i8.ApiProvider>()));
    gh.factory<_i26.RaiseViewStore>(
        () => _i26.RaiseViewStore(get<_i8.ApiProvider>()));
    gh.factory<_i27.ReportStore>(
        () => _i27.ReportStore(get<_i8.ApiProvider>()));
    gh.factory<_i28.RestorePasswordStore>(
        () => _i28.RestorePasswordStore(get<_i8.ApiProvider>()));
    gh.factory<_i29.SettingsPageStore>(
        () => _i29.SettingsPageStore(get<_i8.ApiProvider>()));
    gh.factory<_i30.SignInStore>(
        () => _i30.SignInStore(get<_i8.ApiProvider>()));
    gh.factory<_i31.SignUpStore>(
        () => _i31.SignUpStore(get<_i8.ApiProvider>()));
    gh.factory<_i32.StarredMessageStore>(
        () => _i32.StarredMessageStore(get<_i8.ApiProvider>()));
    gh.factory<_i33.SwapStore>(() => _i33.SwapStore(get<_i8.ApiProvider>()));
    gh.factory<_i34.WithdrawPageStore>(
        () => _i34.WithdrawPageStore(get<_i8.ApiProvider>()));
    gh.factory<_i35.WorkerStore>(
        () => _i35.WorkerStore(get<_i8.ApiProvider>()));
    gh.singleton<_i36.TransferStore>(_i36.TransferStore());
    gh.singleton<_i37.WalletStore>(_i37.WalletStore());
