...
import '../ui/pages/main_page/chat_page/chat_room_page/store/chat_room_store.dart'
    as _i31;
import '../ui/pages/main_page/chat_page/store/chat_store.dart' as _i32;
import '../ui/pages/main_page/my_quests_page/store/my_quest_store.dart' as _i36;
...
import '../ui/pages/main_page/settings_page/pages/SMS_verification_page/store/sms_verification_store.dart'
    as _i41;
import '../ui/pages/main_page/settings_page/store/settings_store.dart' as _i25;
...
import '../ui/pages/main_page/wallet_page/withdraw_page/store/withdraw_page_store.dart'
    as _i29;
import '../ui/pages/pin_code_page/store/pin_code_store.dart' as _i37;
import '../ui/pages/profile_me_store/profile_me_store.dart' as _i38;
import '../ui/pages/report_page/store/report_store.dart' as _i23;
import '../ui/pages/restore_password_page/store.dart' as _i24;
import '../ui/pages/sign_in_page/store/sign_in_store.dart' as _i26;
...
import '../ui/pages/sign_up_page/generate_wallet/create_wallet_store.dart'
    as _i12;
import '../ui/pages/sign_up_page/store/sign_up_store.dart' as _i27;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.factory<_i20.ProfileVisibilityStore>(
        () => _i20.ProfileVisibilityStore(get<_i8.ApiProvider>()));
    gh.factory<_i21.QuestDetailsStore>(
        () => _i21.QuestDetailsStore(get<_i8.ApiProvider>()));
    gh.factory<_i22.RaiseViewStore>(
        () => _i22.RaiseViewStore(get<_i8.ApiProvider>()));
    gh.factory<_i23.ReportStore>(
        () => _i23.ReportStore(get<_i8.ApiProvider>()));
    gh.factory<_i24.RestorePasswordStore>(
        () => _i24.RestorePasswordStore(get<_i8.ApiProvider>()));
    gh.factory<_i25.SettingsPageStore>(
        () => _i25.SettingsPageStore(get<_i8.ApiProvider>()));
    gh.factory<_i26.SignInStore>(
        () => _i26.SignInStore(get<_i8.ApiProvider>()));
    gh.factory<_i27.SignUpStore>(
        () => _i27.SignUpStore(get<_i8.ApiProvider>()));
    gh.factory<_i28.SwapStore>(() => _i28.SwapStore(get<_i8.ApiProvider>()));
    gh.factory<_i29.WithdrawPageStore>(
        () => _i29.WithdrawPageStore(get<_i8.ApiProvider>()));
    gh.factory<_i30.WorkerStore>(
        () => _i30.WorkerStore(get<_i8.ApiProvider>()));
    gh.factory<_i31.ChatRoomStore>(() =>
        _i31.ChatRoomStore(get<_i8.ApiProvider>(), get<_i32.ChatStore>()));
    ...
    gh.singleton<_i32.ChatStore>(_i32.ChatStore(get<_i8.ApiProvider>()));
    gh.singleton<_i35.FilterQuestsStore>(
        _i35.FilterQuestsStore(get<_i8.ApiProvider>()));
    gh.singleton<_i36.MyQuestStore>(_i36.MyQuestStore(get<_i8.ApiProvider>()));
    gh.singleton<_i37.PinCodeStore>(_i37.PinCodeStore(get<_i8.ApiProvider>()));
    gh.singleton<_i38.ProfileMeStore>(
        _i38.ProfileMeStore(get<_i8.ApiProvider>()));
    gh.singleton<_i39.QuestMapStore>(
        _i39.QuestMapStore(get<_i8.ApiProvider>()));
    gh.singleton<_i40.QuestsStore>(_i40.QuestsStore(get<_i8.ApiProvider>()));
    gh.singleton<_i41.SMSVerificationStore>(
        _i41.SMSVerificationStore(get<_i8.ApiProvider>()));
    gh.singleton<_i42.TransactionsStore>(
        _i42.TransactionsStore(get<_i8.ApiProvider>()));
    gh.singleton<_i43.TwoFAStore>(_i43.TwoFAStore(get<_i8.ApiProvider>()));
    gh.singleton<_i44.UserProfileStore>(
        _i44.UserProfileStore(get<_i8.ApiProvider>()));
    return this;
  }
}
