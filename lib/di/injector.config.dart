...
import '../ui/pages/restore_password_page/store.dart' as _i17;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.factory<_i16.RaiseViewStore>(
        () => _i16.RaiseViewStore(get<_i9.ApiProvider>()));
    gh.factory<_i17.RestorePasswordStore>(
        () => _i17.RestorePasswordStore(get<_i9.ApiProvider>()));
    ...
    gh.factory<_i23.WithdrawPageStore>(
        () => _i23.WithdrawPageStore(get<_i9.ApiProvider>()));
    gh.factory<_i24.WorkerStore>(
        () => _i24.WorkerStore(get<_i9.ApiProvider>()));
    gh.factory<_i25.ChatRoomStore>(() =>
        _i25.ChatRoomStore(get<_i9.ApiProvider>(), get<_i26.ChatStore>()));
    ...
    gh.singleton<_i28.FilterQuestsStore>(
        _i28.FilterQuestsStore(get<_i9.ApiProvider>()));
