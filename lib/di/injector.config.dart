...
import '../ui/pages/main_page/chat_page/dispute_page/store/dispute_store.dart'
    as _i3;
import '../ui/pages/main_page/chat_page/repository/conversation_repository.dart'
    as _i9;
import '../ui/pages/main_page/chat_page/store/chat_store.dart' as _i26;
import '../ui/pages/main_page/my_quests_page/store/my_quest_store.dart' as _i27;
...
import '../ui/pages/main_page/wallet_page/withdraw_page/store/withdraw_page_store.dart'
    as _i24;
import '../ui/pages/pin_code_page/store/pin_code_store.dart' as _i28;
import '../ui/pages/profile_me_store/profile_me_store.dart' as _i30;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.factory<_i6.LogService>(() => _i6.LogServiceProd(),
        registerFor: {_prod});
    gh.factory<_i7.ChatRoomStore>(() => _i7.ChatRoomStore(
        get<_i8.ApiProvider>(), get<_i9.ConversationRepository>()));
    ...
    gh.factory<_i12.CreateReviewStore>(
        () => _i12.CreateReviewStore(get<_i8.ApiProvider>()));
    ...
    gh.factory<_i15.QuestMapStore>(
        () => _i15.QuestMapStore(get<_i8.ApiProvider>()));
    gh.factory<_i16.RaiseViewStore>(
        () => _i16.RaiseViewStore(get<_i8.ApiProvider>()));
    gh.factory<_i17.RestorePasswordStore>(
        () => _i17.RestorePasswordStore(get<_i8.ApiProvider>()));
    gh.factory<_i18.SMSVerificationStore>(
        () => _i18.SMSVerificationStore(get<_i8.ApiProvider>()));
    gh.factory<_i19.SettingsPageStore>(
        () => _i19.SettingsPageStore(get<_i8.ApiProvider>()));
    gh.factory<_i20.SignInStore>(
        () => _i20.SignInStore(get<_i8.ApiProvider>()));
    gh.factory<_i21.SignUpStore>(
        () => _i21.SignUpStore(get<_i8.ApiProvider>()));
    gh.factory<_i22.TwoFAStore>(() => _i22.TwoFAStore(get<_i8.ApiProvider>()));
    gh.factory<_i23.WalletStore>(
        () => _i23.WalletStore(get<_i8.ApiProvider>()));
    ...
    gh.singleton<_i9.ConversationRepository>(_i9.ConversationRepository());
