...
import '../ui/pages/main_page/profile_reviews_page/pages/portfolio_page/portfolio_store.dart'
    as _i13;
...
import '../ui/pages/profile_me_store/profile_me_store.dart' as _i27;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.factory<_i8.ChooseRoleStore>(
        () => _i8.ChooseRoleStore(get<_i7.ApiProvider>()));
    gh.factory<_i9.CreateQuestStore>(
        () => _i9.CreateQuestStore(get<_i7.ApiProvider>()));
    gh.factory<_i10.DepositStore>(
        () => _i10.DepositStore(get<_i7.ApiProvider>()));
    gh.factory<_i11.EmployerStore>(
        () => _i11.EmployerStore(get<_i7.ApiProvider>()));
    gh.factory<_i12.MyQuestStore>(
        () => _i12.MyQuestStore(get<_i7.ApiProvider>()));
    gh.factory<_i13.PortfolioStore>(
        () => _i13.PortfolioStore(get<_i7.ApiProvider>()));
    ...
    gh.singleton<_i25.ChatStore>(_i25.ChatStore(get<_i7.ApiProvider>()));
    gh.singleton<_i26.PinCodeStore>(_i26.PinCodeStore(get<_i7.ApiProvider>()));
    gh.singleton<_i27.ProfileMeStore>(
        _i27.ProfileMeStore(get<_i7.ApiProvider>()));
    return this;
  }
}
