...
import '../ui/pages/main_page/my_quests_page/store/my_quest_store.dart' as _i28;
...
import '../ui/pages/main_page/wallet_page/withdraw_page/store/withdraw_page_store.dart'
    as _i24;
import '../ui/pages/pin_code_page/store/pin_code_store.dart' as _i29;
import '../ui/pages/profile_me_store/profile_me_store.dart' as _i31;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.factory<_i14.FilterQuestsStore>(
        () => _i14.FilterQuestsStore(get<_i9.ApiProvider>()));
    ...
    gh.singleton<_i28.MyQuestStore>(_i28.MyQuestStore(get<_i9.ApiProvider>()));
    gh.singleton<_i29.PinCodeStore>(_i29.PinCodeStore(get<_i9.ApiProvider>()));
    gh.singleton<_i30.PortfolioStore>(
        _i30.PortfolioStore(get<_i9.ApiProvider>()));
    gh.singleton<_i31.ProfileMeStore>(
        _i31.ProfileMeStore(get<_i9.ApiProvider>()));
    gh.singleton<_i32.QuestsStore>(_i32.QuestsStore(get<_i9.ApiProvider>()));
    gh.singleton<_i33.UserProfileStore>(
        _i33.UserProfileStore(get<_i9.ApiProvider>()));
    return this;
  }
}
