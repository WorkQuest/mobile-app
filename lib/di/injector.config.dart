...
import '../ui/pages/main_page/my_quests_page/store/my_quest_store.dart' as _i29;
...
import '../ui/pages/main_page/wallet_page/deposit_page/store/deposit_store.dart'
    as _i13;
import '../ui/pages/main_page/wallet_page/store/wallet_store.dart' as _i35;
import '../ui/pages/main_page/wallet_page/withdraw_page/store/withdraw_page_store.dart'
    as _i24;
import '../ui/pages/pin_code_page/store/pin_code_store.dart' as _i30;
import '../ui/pages/profile_me_store/profile_me_store.dart' as _i32;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init(
    ...
    gh.singleton<_i30.PinCodeStore>(_i30.PinCodeStore(get<_i9.ApiProvider>()));
    gh.singleton<_i31.PortfolioStore>(
        _i31.PortfolioStore(get<_i9.ApiProvider>()));
    gh.singleton<_i32.ProfileMeStore>(
        _i32.ProfileMeStore(get<_i9.ApiProvider>()));
    gh.singleton<_i33.QuestsStore>(_i33.QuestsStore(get<_i9.ApiProvider>()));
    gh.singleton<_i34.UserProfileStore>(
        _i34.UserProfileStore(get<_i9.ApiProvider>()));
    gh.singleton<_i35.WalletStore>(_i35.WalletStore(get<_i9.ApiProvider>()));
    return this;
  }
}
