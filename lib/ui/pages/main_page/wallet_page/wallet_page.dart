            ...
            child: Column(
              children: [
                CopyAddressWalletWidget(
                  format: WalletRepository().isOtherNetwork ? FormatAddress.HEX : FormatAddress.BECH32,
                ),
                const SizedBox(
                  height: 20,
                ),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  if (store.isLoading)
                                    ...
                                    Text(
                                      '\$ ${((num.parse(balance.amount!)) * (num.parse(balance.pricePerDollar!))).toStringAsFixed(6)}',
