              ...
              onPressed: () async {
                ...
                Navigator.pushNamed(
                  ...
                  arguments: ReviewPageArguments(
                    userId: widget.arguments?.userId == null ? userStore!.userData!.id : widget.arguments!.userId,
                    role: widget.arguments?.userId == null ? userStore!.userData!.role : widget.arguments!.role,
                    store: portfolioStore!,
                  ),
                );
              },
        ...
        isMyProfile
            ? (userStore!.userData!.additionalInfo!.educations.isNotEmpty)
                ? ListView.builder(
                    ...
                    itemBuilder: (_, index) {
                      final education = userStore!.userData!.additionalInfo!.educations[index];
                      return experience(
            ...
            : (viewOtherUser!.userData!.additionalInfo!.educations.isNotEmpty)
                ? ListView.builder(
                    ...
                    itemBuilder: (_, index) {
                      final education = viewOtherUser!.userData!.additionalInfo!.educations[index];
                      return experience(
                          place: education["place"] ?? "--",
                          from: education["from"] ?? "--",
                          to: education["to"] ?? "--");
        ...
        isMyProfile
            ? (userStore!.userData!.additionalInfo!.workExperiences.isNotEmpty)
                ? ListView.builder(
                    ...
                    shrinkWrap: true,
                    physics: NeverScrollableScrollPhysics(),
                    itemCount: userStore!.userData!.additionalInfo!.workExperiences.length,
                    itemBuilder: (_, index) {
                      final userExperience = userStore!.userData!.additionalInfo!.workExperiences[index];
                      return experience(
            ...
            : (viewOtherUser!.userData!.additionalInfo!.workExperiences.isNotEmpty)
                ? ListView.builder(
                    ...
                    shrinkWrap: true,
                    physics: NeverScrollableScrollPhysics(),
                    itemCount: viewOtherUser!.userData!.additionalInfo!.workExperiences.length,
                    itemBuilder: (_, index) {
                      final userExperience = viewOtherUser!.userData!.additionalInfo!.workExperiences[index];
                      return experience(
                          place: userExperience["place"] ?? "--",
                          from: userExperience["from"] ?? "--",
                          to: userExperience["to"] ?? "--");
