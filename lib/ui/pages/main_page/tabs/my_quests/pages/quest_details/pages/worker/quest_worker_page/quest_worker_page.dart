...
class _QuestWorkerPageState extends State<QuestWorkerPage>
                  ...
                  Observer(
                    builder: (_) => IconButton(
                      ...
                      onPressed: () async {
                        ...
                        store.onStar();
                        questStore.setStar(
                            store.quest.value!.id, store.quest.value!.star);
                      },
                    ),
                  ),
                  IconButton(
                            ...
                            : _dif < 24
                                ? () {
                                    AlertDialogUtils.showInfoAlertDialog(
                                      ...
                                      title: "Error",
                                      content:
                                          "You cannot create a dispute_page until 24"
